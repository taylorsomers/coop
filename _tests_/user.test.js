...
describe('User', () => {
  test('Should fail if user fields are not ["Frederick", "Ernest", "1234 Sunshine Blvd", "Oregon", "97405", "1233456789", "fake@gmail.com", "linkd", "gitHub"]', () => {
    ...
    expect(newUser.zip).toEqual("97405")
